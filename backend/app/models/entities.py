...
class YouTubeProjectCompliance(Base):
    ...
    application_display_name: Mapped[str | None] = mapped_column(String(255))
    ...
    terms_of_service_url: Mapped[str | None] = mapped_column(String(2048))
    application_homepage_url: Mapped[str | None] = mapped_column(String(2048))
    production_oauth_redirect_uri: Mapped[str | None] = mapped_column(String(2048))
    production_frontend_url: Mapped[str | None] = mapped_column(String(2048))
    production_api_url: Mapped[str | None] = mapped_column(String(2048))
    data_retention_summary: Mapped[str | None] = mapped_column(Text)
    user_data_deletion_summary: Mapped[str | None] = mapped_column(Text)
    token_revocation_summary: Mapped[str | None] = mapped_column(Text)
    account_disconnection_summary: Mapped[str | None] = mapped_column(Text)
    quota_monitoring_summary: Mapped[str | None] = mapped_column(Text)
    incident_response_summary: Mapped[str | None] = mapped_column(Text)
    security_contact_summary: Mapped[str | None] = mapped_column(Text)
    intended_submission_date: Mapped[date | None] = mapped_column(Date)
    last_reviewed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    reviewed_by: Mapped[str | None] = mapped_column(String(255))
    human_confirmations_json: Mapped[dict] = mapped_column(JSON, default=dict)
